  ...
  if (isOpen)
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div
          className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-[316px] h-[245px] bg-[#23262b] rounded-[15px]">
          <div
            className="w-[284px] left-[16px] top-[24px] absolute text-center text-white text-sm font-normal font-pretendard">
            프로젝트 코드를 공유하세요!
          </div>
          <button
            onClick={() => {
          ...
          <div
            className="w-[283px] h-[117px] left-[16px] top-[54px] absolute bg-white/10 rounded-lg border border-white/10">
            <button
              onClick={handleCopy}
